...
| `unreal/DeepField/Source/DFMatch/**`, `Content/DF/Match/**` | WS-28 (ADR-0023: the state actors host domain-owned components; a domain attaches its component by a one-line PR to DFMatch) |
