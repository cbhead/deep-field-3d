...
P({ id: 'spire_roof', label: 'Roof bay (8 m)', size: '8×40 m', swatch: '#35332f', stats: { Top: 'y 40.0', Parapet: '±Z edges', Bays: '5' },
  note: 'One 8 m bay of the roof at 40 m: felt slab with gravel strips, a parapet on the two Z edges, a roof drain, a skylight strip over the atrium centre and a service walkway. The X-end parapets are `spire_roof_parapet`. The core stands at the centre; the fight ends here.',
  build(K) {
    ...
    g.add(part('roof_skylight_frame', box(3.6, .5, 4.2), mats.mullion, [0, 40.25, 0])); g.add(part('roof_skylight', box(3.2, .3, 3.8), mats.office_dim, [0, 40.35, 0]));
